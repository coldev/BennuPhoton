...
tamano_posicion2D = sizeof(Posicion2D);
  ...
  write(0,100,10,0,"  Photon. (COMPRESS NET Example) ");
...
begin
  ...
  //====================   ARMA PAQUETE PARA ENVIAR A OTROS CLIENTES =========================
     ...
     //======================== //prepara paquetes
	  ...
	  paquete.data_length = tamanopaquete; 
	  	  //========================	  
	 ...
	 reliable = false; 
	 photon_pack_sendgroup(& paquete, reliable, &Client_Targets,  cuenta_conectados ); //send clients	 
