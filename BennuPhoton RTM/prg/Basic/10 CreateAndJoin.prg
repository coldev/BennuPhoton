...
global
   ...
   string MatchName= "My_CreateJoin"; 
...
Begin
  ...
  write(0,100,10,0,"Press (1)Create  (2)Join ");
  loop
    if (key(_1))
	  opcionConectar=1; 
	  break;
  ...
  delete_text(0); //borra todos los textos write
  ...
  if (opcionConectar==1)
    PHOTON_ROOM_CREATE(); //create room
  else
    PHOTON_ROOM_JOIN();   //join room
  end
 ...
 //==========================================  
  ...
  write(0,100,10,0,"  Photon. (CreateAndJoin Example) ");
